...
return array(
	...
	'defaults' => array(
		...
		'manage_url' => '',
		'manage_label' => 'Profil verwalten',
		'view_url' => '{VIEW_LINK}',
		'view_label' => 'Im Browser ansehen',
		'unsubscribe_url' => '{UNSUBSCRIBE_URL}',
		'unsubscribe_label' => 'Abmelden',
		'align' => 'center',
		'background' => '#f8fafc',
		'text_color' => '#64748b',
		'link_color' => '#2563eb',
	...
	'fields' => array(
		...
		array( 'key' => 'manage_label', 'label' => 'Profil-Linktext', 'type' => 'text' ),
		array( 'key' => 'view_url', 'label' => 'Browser-Ansicht URL', 'type' => 'text' ),
		array( 'key' => 'view_label', 'label' => 'Browser-Ansicht Linktext', 'type' => 'text' ),
		array( 'key' => 'unsubscribe_url', 'label' => 'Abmelde-URL', 'type' => 'text' ),
		array( 'key' => 'unsubscribe_label', 'label' => 'Abmelde-Linktext', 'type' => 'text' ),
		array(
			'key' => 'align',
			'label' => 'Ausrichtung',
			'type' => 'select',
