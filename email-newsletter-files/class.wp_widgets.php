...
class e_newsletter_subscribe extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        if ( isset( $instance['title'] ) )
            ...
            $title = __( 'Abonniere unsere Newsletter', 'email-newsletter' );
        ...
        ?>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'name' ); ?>"><?php _e( 'Name abfragen?', 'email-newsletter' ) ?></label>
            </p>
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'groups' ); ?>"><?php _e( 'Gruppen anzeigen?', 'email-newsletter' ) ?></label>
            </p>
            <?php
            ...
            ?>
                <p>
                    <?php _e( 'Automatisch folgenden Gruppen abonnieren:', 'email-newsletter' ) ?>
                </p>
